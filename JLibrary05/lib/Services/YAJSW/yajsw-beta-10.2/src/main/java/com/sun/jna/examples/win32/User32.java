...
public interface User32 extends W32API
{
	...
	boolean UpdateLayeredWindow(HWND hwnd, HDC hdcDst, POINT pptDst, SIZE psize, HDC hdcSrc, POINT pptSrc, int crKey, BLENDFUNCTION pblend,
			int dwFlags);
	...
	void PostMessageA(HWND hWnd, int msg, WPARAM wParam, LPARAM lParam);
